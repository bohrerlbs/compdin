...
import { criarTarefa, atualizarStatusTarefa, editarTarefa, deletarTarefa } from "./actions"
...
export default function CompdinPanel({ tarefas: initial, userId, userRole }: Props) {
    ...
    setTarefas((prev) => prev.map((t) =>
      t.id === tarefa.id
        ? {
            ...
            responsavel: novoStatus !== "PENDENTE" ? { trigrama: "..." } : null,
            iniciadoEm: novoStatus === "INICIADA" ? new Date() : novoStatus === "PENDENTE" ? null : t.iniciadoEm,
            concluidoEm: novoStatus === "CONCLUIDA" ? new Date() : novoStatus === "PENDENTE" || novoStatus === "INICIADA" ? null : t.concluidoEm,
          }
        : t,
    ))
  }
        ...
        <div style={{ display: "flex", alignItems: "flex-start", gap: 8 }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 6, marginTop: 4, flexWrap: "wrap" }}>
              ...
              {tarefa.responsavel && tarefa.responsavelId !== tarefa.autorId && (
                <>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 4, alignItems: "flex-end", flexShrink: 0 }}>
            {isPending && (
              <button
                onClick={() => handleStatus(tarefa, "INICIADA")}
            ...
            {isStarted && (
              <button
                onClick={() => handleStatus(tarefa, "CONCLUIDA")}
